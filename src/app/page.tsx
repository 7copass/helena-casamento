...
{ id: 1, name: 'Deus te iluminou e você resolveu dar uma boa ajuda na nossa lua de mel', price: 3808.97, category: 'honeymoon', active: true, display_order: 1, image_url: null, description: null, created_at: new Date() },
    ...
    { id: 100, name: 'Camisa do time de coração para a alegria do noivo', price: 274.69, category: 'groom', active: true, display_order: 18, image_url: null, description: null, created_at: new Date() },
    { id: 101, name: 'Camisa do time de coração para a alegria do noivo', price: 274.69, category: 'groom', active: true, display_order: 18, image_url: null, description: null, created_at: new Date() },
    { id: 102, name: 'Camisa do time de coração para a alegria do noivo', price: 274.69, category: 'groom', active: true, display_order: 18, image_url: null, description: null, created_at: new Date() },
    { id: 103, name: 'Ajuda para o enxoval do bebê… calma. É brincadeira! (opção 1)', price: 262.10, category: 'funny', active: true, display_order: 19, image_url: null, description: null, created_at: new Date() },
    { id: 104, name: 'Ajuda para o enxoval do bebê… calma. É brincadeira! (opção 1)', price: 262.10, category: 'funny', active: true, display_order: 19, image_url: null, description: null, created_at: new Date() },
    { id: 105, name: 'Ajuda para o enxoval do bebê… calma. É brincadeira! (opção 1)', price: 262.10, category: 'funny', active: true, display_order: 19, image_url: null, description: null, created_at: new Date() },
    { id: 106, name: 'Ajuda para o enxoval do bebê… calma. É brincadeira! (opção 2)', price: 232.64, category: 'funny', active: true, display_order: 20, image_url: null, description: null, created_at: new Date() },
    { id: 107, name: 'Ajuda para o enxoval do bebê… calma. É brincadeira! (opção 2)', price: 232.64, category: 'funny', active: true, display_order: 20, image_url: null, description: null, created_at: new Date() },
    { id: 108, name: 'Ajuda para o enxoval do bebê… calma. É brincadeira! (opção 2)', price: 232.64, category: 'funny', active: true, display_order: 20, image_url: null, description: null, created_at: new Date() },
    { id: 109, name: 'Roupa sexy para a noite de núpcias (opção 1)', price: 262.10, category: 'honeymoon', active: true, display_order: 21, image_url: null, description: null, created_at: new Date() },
    { id: 110, name: 'Roupa sexy para a noite de núpcias (opção 1)', price: 262.10, category: 'honeymoon', active: true, display_order: 21, image_url: null, description: null, created_at: new Date() },
    { id: 111, name: 'Roupa sexy para a noite de núpcias (opção 1)', price: 262.10, category: 'honeymoon', active: true, display_order: 21, image_url: null, description: null, created_at: new Date() },
    { id: 112, name: 'Roupa sexy para a noite de núpcias (opção 2)', price: 232.64, category: 'honeymoon', active: true, display_order: 22, image_url: null, description: null, created_at: new Date() },
    { id: 113, name: 'Roupa sexy para a noite de núpcias (opção 2)', price: 232.64, category: 'honeymoon', active: true, display_order: 22, image_url: null, description: null, created_at: new Date() },
    { id: 114, name: 'Roupa sexy para a noite de núpcias (opção 2)', price: 232.64, category: 'honeymoon', active: true, display_order: 22, image_url: null, description: null, created_at: new Date() },
    { id: 115, name: 'Sal pra não perder o tempero do relacionamento', price: 232.13, category: 'funny', active: true, display_order: 23, image_url: null, description: null, created_at: new Date() },
    { id: 116, name: 'Sal pra não perder o tempero do relacionamento', price: 232.13, category: 'funny', active: true, display_order: 23, image_url: null, description: null, created_at: new Date() },
    { id: 117, name: 'Sal pra não perder o tempero do relacionamento', price: 232.13, category: 'funny', active: true, display_order: 23, image_url: null, description: null, created_at: new Date() },
    { id: 118, name: 'Oportunidade de ser o amigo/parente favorito dos noivos', price: 229.23, category: 'funny', active: true, display_order: 24, image_url: null, description: null, created_at: new Date() },
    { id: 119, name: 'Oportunidade de ser o amigo/parente favorito dos noivos', price: 229.23, category: 'funny', active: true, display_order: 24, image_url: null, description: null, created_at: new Date() },
    { id: 120, name: 'Oportunidade de ser o amigo/parente favorito dos noivos', price: 229.23, category: 'funny', active: true, display_order: 24, image_url: null, description: null, created_at: new Date() },
    { id: 121, name: 'Para ajudar a manter a chama dos noivos acesa', price: 220.89, category: 'funny', active: true, display_order: 25, image_url: null, description: null, created_at: new Date() },
    { id: 122, name: 'Para ajudar a manter a chama dos noivos acesa', price: 220.89, category: 'funny', active: true, display_order: 25, image_url: null, description: null, created_at: new Date() },
    { id: 123, name: 'Para ajudar a manter a chama dos noivos acesa', price: 220.89, category: 'funny', active: true, display_order: 25, image_url: null, description: null, created_at: new Date() },
    { id: 124, name: 'Ajuda para a aposentadoria dos noivos', price: 208.09, category: 'funny', active: true, display_order: 26, image_url: null, description: null, created_at: new Date() },
    { id: 125, name: 'Ajuda para a aposentadoria dos noivos', price: 208.09, category: 'funny', active: true, display_order: 26, image_url: null, description: null, created_at: new Date() },
    { id: 126, name: 'Ajuda para a aposentadoria dos noivos', price: 208.09, category: 'funny', active: true, display_order: 26, image_url: null, description: null, created_at: new Date() },
    { id: 127, name: 'Cura da ressaca para o noivo', price: 208.09, category: 'funny', active: true, display_order: 27, image_url: null, description: null, created_at: new Date() },
    { id: 128, name: 'Cura da ressaca para o noivo', price: 208.09, category: 'funny', active: true, display_order: 27, image_url: null, description: null, created_at: new Date() },
    { id: 129, name: 'Cura da ressaca para o noivo', price: 208.09, category: 'funny', active: true, display_order: 27, image_url: null, description: null, created_at: new Date() },
